...
<div class="detail-content">
    <div class="detail-header">
        <h1 class="header-title">勤怠詳細 todo phpをコントローラーにまとめる</h1>
    </div>
            ...
            <div class="detail-table">
                <table class="detail-table__inner">
                    ...
                    <tr class="detail-table__row">
                        ...
                        <td>
                            <div class="detail-attendance">
                                <input type="text" name="clock_in" class="time-input" value="{{ optional($clockIn)->format('H:i') }}"{{ $isPending ? 'readonly' : '' }}>
                                
                                <span class="hyphen">～</span>
                                <input type="text" name="clock_out" class="time-input" value="{{ optional($clockOut)->format('H:i') }}"{{ $isPending ? 'readonly' : '' }}>
                        ...
                        <tr class="detail-table__row">
                            ...
                            <td>
                                <div class="detail-break">
                                    ...
                                    value="{{ $break->start }}"{{ $isPending ? 'readonly' : '' }}>
                                    
                                    <span class="hyphen">～</span>

                                    <input type="text" name="breaks[{{ $i }}][end]" class="time-input" value="{{ $break->end }}"{{ $isPending ? 'readonly' : '' }}>
                    ...
                    <tr class="detail-table__row">
                        <th>備考</th>
                        <td>
                        <textarea name="remark" {{ $isPending ? 'readonly' : '' }}>{{ $remark }}</textarea>
                        </td>
                    </tr>
                </table>
            </div>
